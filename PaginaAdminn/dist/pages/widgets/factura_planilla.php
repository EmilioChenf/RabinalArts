...
<main class="app-main p-4">
        <div class="container">
          ...
          <div style="position: relative;">
            <img src="../../../dist/assets/img/rabi.png" alt="Logo Rabinalarts" style="position:absolute; top:0; right:0; height:60px;">
          </div>
          ...
          <form method="GET" class="row g-3 mb-4">
            <div class="col-md-4">
              ...
              <input type="month" name="periodo_mes" id="periodo_mes" class="form-control"
                     value="<?= htmlspecialchars($periodo_mes) ?>" required>
            </div>
          ...
          <?php if (count($planillas) > 0): ?>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <input id="desc_partida" class="form-control" value="<?= 'Planilla mensual '.$periodo_mes ?>">
              </div>
              <div class="col-md-3 d-flex align-items-end">
    ...
    <script>
      // Un SOLO listener para el botón (modo mensual)
      document.getElementById('btnPartidaAuto')?.addEventListener('click', async function(){
        ...
        try {
          ...
          // abrir y también dejar el botón de exportar
          const url = `exportar_partida_planilla_pdf.php?partida_id=${data.partida_id}`;
          window.open(url, '_blank');

          document.getElementById('exportBtnContainer').innerHTML =
            `<a href="${url}" target="_blank" class="btn btn-danger mt-2">
               📄 Exportar Partida PDF (#${data.partida_id})
             </a>`;
        } catch(e) {
    ...
    <script>
      // Scrollbars del sidebar (opcional)
